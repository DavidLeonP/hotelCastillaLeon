...
<table class="table table-bordered table-hover">
    ...
    <tr>
        <td>INGRESOS:</td>
        <td>Bs.   <?php echo number_format($ingreso,2,'.',',');?></td>
    </tr>
    <tr>
        <td>EGRESOS:</td>
        <td> Bs.    <?php echo number_format($egreso,2,'.',','); ?></td>
    </tr>
    <tr>
        <td>NETO:</td>
        <td>Bs.   <?php echo number_format($ingreso-$egreso,2,'.',','); ?></td>
    </tr>
</table>
...
?>
    ...
    case 6: echo "Sabado".', '.$numero1.' de '.$mes; break; 
                ...
                <td style="width: 40%;">
                    ...
                    if(count($boletas)>0){
                        ...
                        Bs.   <?php echo number_format($subcero+$cero,2,'.',','); ?>
 ...
 ?>
                        Bs.   <?php echo number_format($cero1+$cero101+$cero102,2,'.',','); ?>
