        ...
        <div id="wrap" class="animsition">
            ...
            <section id="header">
                <header class="clearfix">
                    ...
                    <div class="branding">
                        <a class="brand" href="./">
                            <span><strong>HOTEL COLONIAL</strong></span>
                        </a>
                                ...
                                ?>
                                        ...
                                        -->
                                            ...
                                            <li>
                                              ...
                                              <ul >
                                                <li><a href="./?view=reporte_diario"><i class="fa fa-caret-right"></i> Alojamiento diario</a></li>
                                                <li><a href="./?view=reporte_mensual"><i class="fa fa-caret-right"></i> Alojamiento mensual</a></li>
                                                <li><a href="./?view=pre_reporte_rango"><i class="fa fa-caret-right"></i> Alojamiento por fecha</a></li>
