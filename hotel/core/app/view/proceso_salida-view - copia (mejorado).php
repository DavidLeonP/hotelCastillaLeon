          ...
          <div class="box box-default" >
            ...
            <div class="box-body">
              <table class="table table-bordered">
                  ...
                  <th colspan="4" style="border-right:1px solid #a09e9e;"></th>
                ...
                <tr>
                  ...
                  <th style="border-right:1px solid #a09e9e;">Días de más</th>
             ...
             <form action="index.php?view=addsalida" method="post" name="sumar">
                <tr>
                  ...
                  <td colspan="2"><input value ="<?php echo $habitacion->precio*($horaf ->days - $habitacion->cant_noche); ?>" type="number" value="0" id="numero2" name="numero2" size="2" onKeyUp="fncSumar()" onchange="fncSumar()" min="0"></td>

                  <!------------------------------------------------------------------------------------------------------>

                  <td style="border-right: 1px solid #a09e9e;"><?php echo ($horaf ->days - $habitacion->cant_noche); ?></td>
                ...
                <tr>
                  ...
                  <th></th>
                  <th></th>
                  <th style="border-right:1px solid #a09e9e;">Estado tarifa</th>
                ...
                <tr style="">
                  <th style="width: 10px;border-right: 1px solid #a09e9e;"></th>
                  <th colspan="4" ></th>
                  <th style="border-right: 1px solid #a09e9e;">Carga por salir tarde</th>
                  <th ><input type="text" value="<?php echo $habitacion->precio*(($horaf ->days - $habitacion->cant_noche)); ?>" style="border-color: red;" readonly="readonly" name="resultado5"/></th>
                </tr>

                <tr style="background-color: #dcd6d6;">
                  <th style="width: 10px;border-right: 1px solid #a09e9e;"></th>
                  <th colspan="4" >Servicio al cuarto</th>
                  <th style="border-right: 1px solid #a09e9e;"></th>
                  <th style="width: 100px"></th>
                </tr>
                ...
                <?php $productos = ProcesoVentaData::getByAll($_GET['id']);
                   ...
                   <?php foreach($productos as $producto):?>
                      ...
                      <?php }; ?>
		                  <td><span style="font-size:20px;" class="badge"><b>$   <?php echo number_format($sub_total,2,'.',','); ?></b></span></td>
		                </tr>
               ...
               <?php }else{ 
                ...
                <tr style="background-color: #dcd6d6;">
                  ...
                  <?php if($habitacion->pagado=='1'){ $sumarrr=$habitacion->precio*(($horaf ->days - $habitacion->cant_noche));}else{ $sumarrr= $habitacion->precio*($habitacion->cant_noche+($horaf ->days - $habitacion->cant_noche));  } ?>
