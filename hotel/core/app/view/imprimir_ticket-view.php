                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            <div class="nav-heading">
                                <h3>TICKET N° : <strong class="text-greensea">0000<?php echo $operacion->id; ?></strong></h3>
                                                        ...
                                                        <div class="row b-t pt-20">
                                                            ...
                                                            <div class="col-md-3 b-r">
                                                                ...
                                                                <ul class="list-unstyled text-default lt mb-20">
                                                                    ...
                                                                    <li><b>TICKET N°: 0000<?php echo $operacion->id; ?></b> </li>
                                                            ...
                                                            <!-- col -->
                                                            <div class="col-md-5">
                                                                <p class="text-uppercase text-strong mb-10 custom-font">HUESPED</p>
                                                               <ul class="list-unstyled text-default lt mb-20">
                                                                    <li><strong class="inline-block w-xs">Nombre:</strong> <?php echo $operacion->getCliente()->nombre; ?></li>
                                                                    <li><strong class="inline-block w-xs">C.I.:</strong>  <?php echo $operacion->getCliente()->documento; ?></li>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover table-striped">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>Bs.  <?php echo number_format($operacion->precio,0,'.',','); ?></td>
                                                                    <!--<td class="ng-binding"><b>$  <?php echo number_format(($operacion->precio*$operacion->cant_noche)+$operacion->total,0,'.',','); ?> </b></td>-->
                                                                    <td class="ng-binding"><b>Bs.  <?php echo number_format (($operacion->cant_noche*$operacion->precio),2,'.',','); ?> </b></td>
                                                            ...
                                                            <?php $productos = ProcesoVentaData::getByAll($operacion->id);
                                                               ...
                                                               <?php foreach($productos as $producto):?>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td>Bs.  <?php echo number_format($producto->precio,0,'.',','); ?></td>

                                                                  <?php $sub_total=$producto->precio*$producto->cantidad; ?>

                                                                  <td><b>Bs.  <?php echo number_format($sub_total,0,'.',','); ?></b></td>
                                                ...
                                                <section class="tile tile-simple bg-tr-black lter">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <?php $final= $total+(($operacion->precio*$operacion->cant_noche)+$operacion->carga_salida_tarde);?>
                                                            
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Carga salida tarde:</strong> Bs.  <?php echo number_format($operacion->carga_salida_tarde,2,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Subtotal:</strong> Bs.  <?php echo number_format(($final/(($iva/100)+1)),0,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">IVA:</strong>  Bs.  <?php echo number_format($final-($final/(($iva/100)+1)),0,'.',','); ?></li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5"> Total:</strong>  Bs.  <?php echo number_format($final,0,'.',','); ?></li>
