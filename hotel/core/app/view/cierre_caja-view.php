                ...
                <table>
                  ...
                  <tr>
                   ...
                   <!-- INGRESOS -->
                                            ...
                                            <?php ?>
                  <tr>
                      <td><h5>MONTO CIERRE: Bs.  </h5></td>
                      <td>
                        <input type="text" name="monto_apertura" required class="form-control text-red" placeholder="Ingrese monto" style="border-color: #dd4b47;" value="<?php echo number_format($caja_abierta->monto_apertura+$total_ingreso-$total_egreso,0,'.',','); ?>">
                      </td>
                  </tr>
                </table>
      ...
      <div class="tile-body">
         ...
         <?php if(count($cajas)>0){?>
              ...
              <tr>
                ...
                <td>Bs.   <?php echo number_format($caja->monto_apertura,0,'.',','); ?></td>


                <td><?php echo $caja->fecha_cierre; ?></td>


                <td><?php if($caja->estado==1){ echo 'Bs.   '.number_format($caja_abierta->monto_apertura+$total_ingreso-$total_egreso,0,'.',',');} 
                  else {echo 'Bs.   '.number_format($caja->monto_apertura+$caja->monto_cierre,0,'.',',');} ?>
                </td>
