...
<input type="hidden" name="hora" value="<?php echo $hora; ?>">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">DESTINATARIO</label>
    <div class="col-md-8">
      <textarea class="form-control" name="destinatario" placeholder="Ingrese el destinatario"></textarea>
    </div>
  </div>
