                  ...
                  <thead style="color: white; background-color: #827e7e;">
                   ...
                   <?php foreach($tarifas_ha as $tarifa_ha):?>
                      <tr>
                        ...
                        <?php $tarifa = TarifaData::getById($tarifa_ha->getTarifa()->id); ?>
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control select2" onchange="CargarTarifa(this.value);" required  name="id_tarifa">   
  ...
  function CargarTarifa(val)
    {
        ...
        $.ajax({
            type: "POST",
            url: 'index.php?action=tarifa_ha',
            data: 'id='+val,
