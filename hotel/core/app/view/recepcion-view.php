      ...
      <div class="tile-body">
          <div class="row">
            <?php if(isset($_GET['buscar']) and $_GET['buscar']!=""){ ?>
                  ...
                  <?php $procesos = ProcesoData::getProcesoHabitacion($cliente->id);
                  if(count($procesos)>0){ ?> 
                  ...
                  <div class="col-lg-2 col-xs-6">
                    <section class="tile bg-danger widget-appointments">
                       <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font" style="font-size: 12px;">Ocupado por <?php echo substr($proceso->getCliente()->nombre, 0,20); ?></h1>
                                    <ul class="controls"> 
                      ...
                      <?php  }; ?>
                            ...
                            <?php if($habitacion->estado==1){?>
                               <!-- tile header -->
                                ...
                                <!-- tile body -->
                                <div class="tile-body" style="padding: 1px;">
                                  <?php $tarifas_ha = TarifaHabitacionData::getAllHabitacion($habitacion->id);?>
                                  <?php foreach($tarifas_ha as $tarifa_ha):?>

                                  <?php endforeach;?>

                                  <h4 style="text-align: center;"><?php echo $habitacion->nombre; ?>&nbsp;<i class="fa fa-bed"></i>&nbsp;&nbsp;&nbsp;<?php echo $habitacion->getCategoria()->nombre;?> </h4>
                                </div> 
                                <!-- /tile body -->
                            <?php } else if($habitacion->estado==2){?>
                               ...
                               <!-- tile header -->
                                ...
                                <div class="tile-body" style="padding: 1px;">
                                   ...
                                   <h4 style="text-align: center;"><?php echo $habitacion->nombre; ?>&nbsp;<i class="fa fa-bed"></i>&nbsp;&nbsp;&nbsp;<?php echo $habitacion->getCategoria()->nombre;?>
                                </div>
                                <!-- /tile body -->
                                <!-- tile body -->
                                <div class="tile-body" style="padding: 1px;">
                                  
                                  <h4 style="text-align: center;"><?php echo substr($proceso->getCliente()->nombre, 0,20); ?></h4>
                                   </h4>
                                </div> 
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
				  ...
				  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> PERSONAL A CARGO </span>
                      <input type="text" class="form-control col-md-8" name="nombre" value="<?php echo $habitacion->personal; ?>" required placeholder="Personal a cargo">
                    </div>
                  </div>
