                                                ...
                                                <section class="tile tile-simple bg-tr-black lter">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                          <?php $final= $total+($operacion->total);?>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Subtotal:</strong> $  <?php echo number_format(($final/(($iva/100)+1)),2,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">IVA:</strong>  $  <?php echo number_format($final-($final/(($iva/100)+1)),2,'.',','); ?></li>
