...
/*echo "<script type=\"text/javascript\">alert(\"El respaldo de la Base de datos se guardo en la carpeta backup de la raiz del sistema\");</script>"; 
