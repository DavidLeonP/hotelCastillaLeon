              ...
              <div class="tile-body p-0" style="text-align: left;">
                ...
                <table>
                  ...
                  <tr>
                      ...
                      <td><input type="text" name="monto_apertura" id="monto_apertura" onchange="this.value=this.value.replace(/\.$/, '')"  onKeyUp="if (isNaN(this.value)) this.value=this.value.replace(/[^0-9.]/g,'')" required class="form-control text-red" placeholder="Ingrese monto" style="border-color: #dd4b47;"></td>
...
<script type="text/javascript">
  document.getElementById("monto_apertura").focus();
</script>
...
<!-- tile -->
    ...
    color: white;">
                                        ...
                                        <tr> 
                                            ...
                                            <td>Bs.   <?php echo number_format($cajas->monto_apertura,0,'.',','); ?></td>
                                            ...
                                            <td>Bs.   <?php echo number_format($total_egreso,0,'.',','); ?></td>
                                            <td>Bs.   <?php echo number_format($total_ingreso,0,'.',','); ?></td>
                                                <?php $total=($cajas->monto_apertura+$total_ingreso)-$total_egreso; ?>
                                            <td>Bs.   <?php echo number_format($total,0,'.',','); ?></td>
