...
<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addproceso" role="form">
                  ...
                  <td colspan="2">
                    ...
                    <div class="tile-body">                              
                              <div class="input-group">
                                ...
                                <div class="input-group-addon">
                                  <i class="fa  fa-arrow-circle-o-right"></i>  C.I. :
                                </div>
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre"  required="required" placeholder="Ingrese nombre" >
                              </div>
                              <!-- /.input group -->
                            </div>
      ...
      <td colspan="3">
                  ...
                  <select class="form-control" onchange="CargarTarifa(this.value);" required name="id_tarifa">
                    <?php $tarifas_ha = TarifaHabitacionData::getAllHabitacion($_GET['id_habitacion']);?>
                      ...
                      <?php foreach($tarifas_ha as $tarifa_ha):?>
                        <option value="<?php echo $tarifa_ha->id_tarifa;?>" ><?php echo $tarifa_ha->getTarifa()->nombre;?></option>
                      <?php endforeach;?> 
              ...
              <div class="form-group">
                ...
                <button type="submit" class="btn btn-success pull-right" id="registrar_ingreso">Registrar ingreso</button>
                <?php
                ...
                if ($caja_data !== null) {
                  ...
                  ?>
                    <script>
                      ...
                      alert("No puedes ingresar personas si no hay ninguna caja abierta");
                      btnRegistrarngreso.disabled = true;
                      //AGREGADO POR HUGO
