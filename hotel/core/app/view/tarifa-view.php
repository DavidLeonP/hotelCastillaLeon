                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="precio" value="<?php echo $tarifa->precio; ?>" required placeholder="Ingrese precio">
                          </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"> Precio</span>
                      <input type="text" class="form-control" name="precio" required placeholder="Ingrese precio">
                    </div>
