                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->razon_social; ?>" name="razon_social"  placeholder="Ingrese Procedencia (OPCIONAL)">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->giro; ?>" name="giro"  placeholder="Ingrese Nacionalidad (OPCIONAL)">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->ocupacion; ?>" name="ocupacion"  placeholder="Ingrese Dirección (OPCIONAL)">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->estado_civil; ?>" name="estado_civil"  placeholder="Ingrese Dirección (OPCIONAL)">
                    </div>
                  </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Nombres y Apellido </span>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Procedencia </span>
                      <input type="text" class="form-control col-md-8" name="razon_social"  placeholder="Ingrese Procedencia (OPCIONAL)">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Nacionalidad </span>
                      <input type="text" class="form-control col-md-8" name="giro"  placeholder="Ingrese Nacionalidad (OPCIONAL)">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Ocupación </span>
                      <input type="text" class="form-control col-md-8" name="ocupacion"  placeholder="Ingrese Ocupación">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Estado civil </span>
                      <input type="text" class="form-control col-md-8" name="estado_civil"  placeholder="Ingrese Estado civil">
                    </div>
                  </div>
