                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover table-striped">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>Bs.  <?php echo number_format($operacion->precio,2,'.',','); ?></td>
                                                                    <!--<td class="ng-binding"><b>$  <?php echo number_format($operacion->total,2,'.',','); ?> </b></td>-->
                                                            ...
                                                            <?php $productos = ProcesoVentaData::getByAll($operacion->id);
                                                               ...
                                                               <?php foreach($productos as $producto):?>
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td><b>Bs.  <?php echo number_format($sub_total,2,'.',','); ?></b></td>
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <ul class="list-unstyled">
                                                           ...
                                                           <li class="ng-binding"><strong class="inline-block w-sm mb-5">Carga salida tarde:</strong> Bs.  <?php echo number_format($operacion->carga_salida_tarde,2,'.',','); ?> </li>
                                                            ...
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Subtotal:</strong> Bs.  <?php echo number_format(($final/(($iva/100)+1)),2,'.',','); ?> </li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">IVA:</strong>  Bs.  <?php echo number_format($final-($final/(($iva/100)+1)),2,'.',','); ?></li>
                                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5"> Total:</strong>  Bs.  <?php echo number_format($final,2,'.',','); ?></li>
