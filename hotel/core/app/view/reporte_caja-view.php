                                              ...
                                              <?php $montos_sin_cerrar = ProcesoData::getIngresoCaja($id_caja);
                                                    ...
                                                    if(count($montos_sin_cerrar)>0){
                                                      ...
                                                      foreach($montos_sin_cerrar as $monto_sin_cerrar):
                                                       ...
                                                       $total_sin_cerrar=($monto_sin_cerrar->total)+$total_sin_cerrar;
                                                      endforeach;
                ...
                <table class="table mb-0">
                  ...
                  <tr>
                   ...
                   <tr>
                      ...
                      <td>
                        <h5 class="control-label text-red"><br>Bs.   <?php echo number_format($caja_abierta->monto_apertura,0,'.',','); ?></h5></td>
                  </tr>
                  <tr>
                      <td><h5><br>Alquiler habitación:</h5></td>
                      <td>
                        <h5 class="control-label text-red"><br>Bs.   <?php echo number_format($total_sin_cerrar,0,'.',','); ?></h5></td>
                  </tr>
                  <tr>
                      <td><h5><br>Servicio habitación:</h5></td>
                      <td>
                        <h5 class="control-label text-red"><br>Bs.   <?php echo number_format($subtotal3,0,'.',','); ?></h5></td>
                  </tr>
                  <tr>
                      <td><h5><br>Egresos:</h5></td>
                      <td>
                        <h5 class="control-label text-red"><br>Bs.  <?php echo number_format($total_egreso,0,'.',','); ?></h5></td>
                  </tr>
                  <tr style="border-top: 2px solid #00a65a">
                      <td><h5><br>TOTAL:</h5></td>
                      <td>
                        <h5 class="control-label text-red"><br>Bs.  <?php echo number_format($caja_abierta->monto_apertura+$total_ingreso-$total_egreso,0,'.',','); ?></h5></td>
                  </tr>
                  ...
                  <thead style="color: black; background-color: #d2d6de;">
                   ...
                   <?php $numero=$numero+1;?>
                      <tr>
                        ...
                        <td><b>Bs.    <?php echo number_format($reportediario->precio,0,'.',','); ?></b></td>
                        <td><b>Bs.   <?php echo number_format($reportediario->cant_noche,0,'.',','); ?></b></td>
                        <!--<?php $subtotal= ($reportediario->precio*$reportediario->cant_noche)+$reportediario->total ?>-->
                        <?php $subtotal=$reportediario->total ?>
                        <td>Bs.   <?php echo number_format($subtotal,0,'.',','); ?></td>
                    ...
                    <?php endforeach; ?>
                     ...
                     <tfoot style="color: black; background-color: #e3e4e6;">
                        ...
                        <th><b>Bs.    <?php echo number_format($total,0,'.',','); ?> </b></th> 
                        <th></th>
                        <th></th>
                    </tfoot>
                  ...
                  <thead style="color: black; background-color: #d2d6de;">
                   ...
                   <?php $numero=$numero+1;?>
                      ...
                      <tr>
                        ...
                        <td><b>Bs.   <?php echo number_format($reporproduct->precio,2,'.',','); ?></b></td>
                        <?php $subtotal1=$reporproduct->cantidad*$reporproduct->precio; ?>
                    ...
                    <tfoot style="color: black; background-color: #e3e4e6;">
                        ...
                        <th><b>Bs.    <?php echo number_format($subtotal2,2,'.',','); ?></b> </th> 
                        <th></th>
                    </tfoot>
