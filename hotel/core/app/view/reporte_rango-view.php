...
<div class="row">
 ...
 <section class="content-header">
      <h3>
        <span class="fa fa-file-text-o"></span> REPORTE ALOJAMIENTO POR FECHA &nbsp <a href="javascript:print();"  class=""><i class="fa fa-print"></i> IMPRIMIR</a>
      </h3> 
      <!--<ol class="breadcrumb">
...
<div class="row">
  ...
  <div class="col-md-12">
          ...
          <?php
          $inicio = date_create($_POST['start']);
          $final = date_create($_POST['end']);

          ?>
          <h4><?php  echo 'DESDE: '.date_format($inicio,"d/m/Y").'    HASTA: '.date_format($final,"d/m/Y") ; ?><br></h4>
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" style="background-color: #d2d6de;">
              <!--<li class="active"><a href="#tab_1" data-toggle="tab">Alojamiento</a></li>-->
              ...
              <div class="tab-pane active" id="tab_1"> 
                ...
                if(count($reportediarios)>0){
                  ...
                  <thead style="color: black; background-color: #d2d6de;">
                   ...
                   <?php $numero=$numero+1;?>
                      <tr>
                        <!--<td><a href="<?php// echo 'index.php?view=imprimir_ticket&id='.$reportediario->id; ?>" target="_blank"><i class="fa fa-print"></i></a></td>-->
                        ...
                        <td><?php echo $reportediario->getCliente()->giro; ?></td><!--NACIONALIDAD-->
                        <td><?php echo $reportediario->getCliente()->estado_civil; ?></td>
                        <td><?php echo $reportediario->getCliente()->ocupacion; ?></td>

                        <td><?php echo $reportediario->getCliente()->razon_social; ?></td>
                   ...
                   <!--  <tfoot style="color: black; background-color: #e3e4e6;">
                        ...
                        <th><b>Bs.   <?php echo number_format($total,2,'.',','); ?> </b></th> 
                        <th></th>
                        <th></th>
                        <th></th>
                    </tfoot>-->
