            ...
            <div class="col-md-offset-1 col-md-10">
              ...
              <!--<div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="ocupacion"  placeholder="Ingrese Dirección (OPCIONAL)">
                    </div>
             </div>
             ...
             <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="estado_civil"  placeholder="Ingrese Dirección (OPCIONAL)">
                    </div>
             </div>-->
