...
class GastoData {
	...
	public function add(){
		$sql = "insert into gasto (descripcion,precio,id_usuario,fecha,hora,id_caja,fecha_creacion,destinatario) ";
		$sql .= "value (\"$this->descripcion\",\"$this->precio\",$this->id_usuario,\"$this->fecha\",\"$this->hora\",\"$this->id_caja\",NOW(),\"$this->destinatario\")";
...
// partiendo de que ya tenemos creado un objecto CategoryData previamente utilizamos el contexto
	public function update(){
		$sql = "update ".self::$tablename." set descripcion=\"$this->descripcion\",precio=\"$this->precio\",destinatario=\"$this->destinatario\", where id=$this->id";
		Executor::doit($sql);
	}
