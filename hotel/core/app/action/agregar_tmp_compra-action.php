	...
	$del->del();
		...
		$tmps = TmpData::getAllTemporalCompra($session_id);
            ...
            <tr style="background-color: #f3f3f3;">
                ...
                <td><span class="pull-left"><?php echo '$  '.number_format(($sumador_total/(($iva/100)+1)),2,'.',',');?></span></td>
                <td></td>
            </tr>
            <tr style="background-color: #f3f3f3;">
                <td colspan=4><span class="pull-right">IGV </span></td>
                <td><span class="pull-left"><?php echo '$  '.number_format($sumador_total-($sumador_total/(($iva/100)+1)),2,'.',',');?></span></td>
                <td></td>
            </tr>
